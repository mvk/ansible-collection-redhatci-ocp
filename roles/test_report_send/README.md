...
The role sends a single event made of `trs_report_path`, `trs_metadata_path`
And environment variables (specific CI, and its metadata)
...
If set to be empty or the file is missing, it is ignored.
  ...
  - **trs_collector_auth_headers**
    ...
    - **Type**: dict
    - **Default**: {}
    - **Description**: Collector authentication headers
  ...
  - **trs_ci_detect_skip**
    ...
    - **Type**: bool
    - **Default**: False
    - **Description**: Skip auto-detection of CI system (for development)
