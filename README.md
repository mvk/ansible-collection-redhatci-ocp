...
[redhatci.ocp.report_send](https://github.com/redhatci/ansible-collection-redhatci-ocp/blob/main/roles/report_send/README.md) | Sends reporting event json file to reporting system (splunk), its input is the product of [redhatci.ocp.report_combine](https://github.com/redhatci/ansible-collection-redhatci-ocp/blob/main/roles/report_combine/README.md)
